...
'''
use ewatercycle environment
script written with help from Jerom
data on tintin + running on tintin using slurm -> see jobfile
runs parallel the grid to catchment conversion
...
# Set Paths (Shown are for tintin) --> change paths for different datasets
SHAPE_DIR = Path("/home/vanoorschot/work/fransje/scripts/GLOBAL_SR/grid_to_catchments/selected_shapes/")
#NC4_DIR = Path("/home/vanoorschot/work/fransje/DATA/GSWP3_0.5degree/")
NC4_DIR = Path("/home/vanoorschot/work/fransje/scripts/GLOBAL_SR/grid_to_catchments/nc_dir_gswp_p/2001_2010/")
OUT_DIR = Path("/home/vanoorschot/work/fransje/scripts/GLOBAL_SR/grid_to_catchments/out_csv_gswp_p/2001_2010/")
